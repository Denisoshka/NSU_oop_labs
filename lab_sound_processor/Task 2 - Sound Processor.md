...
Напишите утилиту командной строки для конверсии звуковых файлов формата WAVReader. Программа получает на вход набор исходных файлов (input1.wav, input2.wav, и т.д.) и текстовый файл примерно следующего содержания:
