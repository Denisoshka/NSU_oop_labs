...
Напишите утилиту командной строки для конверсии звуковых файлов формата WAVReader. Конверсия означает, что программа получает на вход набор исходных файлов (input1.wav, input2.wav, и т.д.) и текстовый файл примерно следующего содержания:
...
На выходе программа создает новый WAVReader-файл со звуком, соответствующим переданной конфигурации.
